...
const Home = () => {
  ...
  const handleReadMoreTour = (id) => {
    console.log(id);
    history.push("tournament-result/" + id);
  };
    ...
    <Spin spinning={false}>
      ...
      >
        ...
        >
          <Row justify="center" align="top" key="1" style={{ display: "flex" }}>
            <Col span={4} style={{ height: "100%" }}>
              <ul
                className="menu-tree"
                style={{ height: "100%", backgroundColor: "rgb(23, 69, 139)" }}
              >
              ...
              >
                <div className="img">
                  <img
                    ...
                    src="https://img.thegioithethao.vn/thumbs/san-bong-da/ha-noi/tay-ho/san-dai-phat/san-bong-dai-phat-7_thumb_720.webp"
                    alt=""
                  />
                </div>
                <div className="img">
                  <img
                    style={{ width: "100%", height: 300, objectFit: "cover" }}
                    src="https://img.thegioithethao.vn/thumbs/san-bong-da/ha-noi/tay-ho/san-dai-phat/san-bong-dai-phat-8_thumb_720.webp"
                    alt=""
                  />
                </div>
                <div className="img">
                  <img
                    style={{ width: "100%", height: 300, objectFit: "cover" }}
                    src="https://img.thegioithethao.vn/thumbs/san-bong-da/ha-noi/tay-ho/san-dai-phat/san-bong-dai-phat-3_thumb_720.webp"
                    alt=""
                  />
                </div>
                <div className="img">
                  <img
                    style={{ width: "100%", height: 300, objectFit: "cover" }}
                    src="https://img.thegioithethao.vn/thumbs/san-bong-da/ha-noi/tay-ho/san-dai-phat/san-bong-dai-phat-4_thumb_720.webp"
                    alt=""
                  />
                </div>
              </Carousel>
              <div className="product-promotion" style={{ height: "100%" }}>
                <div class="product-card">
                  <div class="product-image">
                    <img
                      src="https://img.thegioithethao.vn/thumbs/thuong-hieu/avg-1982_thumb_150.png"
                      alt="Sản phẩm 1"
                    />
                  </div>
                ...
                <div class="product-card">
                  <div class="product-image">
                    <img
                      src="https://img.thegioithethao.vn/thumbs/thuong-hieu/kamito-logo_thumb_150.png"
                      alt="Sản phẩm 2"
                    />
                  </div>
                ...
                <div class="product-card">
                  <div class="product-image">
                    <img
                      src="https://img.thegioithethao.vn/thumbs/thuong-hieu/molten-logo_thumb_150.png"
                      alt="Sản phẩm 3"
                    />
                  </div>
            ...
            <Col span={5} style={{ height: "100%" }}>
              <div
                class="right-banner image-promotion"
                style={{ height: "100%" }}
              >
                <a href="#" class="right-banner__item">
                  <img
                    src="https://sanbongconhantao.com.vn/wp-content/uploads/2019/01/Co-nhan-tao-san-bong.jpg"
                    loading="lazy"
                ...
                <a href="#" class="right-banner__item">
                  <img
                    src="https://sanbongconhantao.com.vn/wp-content/uploads/2019/09/th%E1%BA%A3m-s%C3%A0n-%C4%91%C6%B0%E1%BB%9Dng-ch%E1%BA%A1y-cao-su-32-1-Copy-min.jpg"
                    loading="lazy"
                    class="right-banner__img"
                  />
                </a>
                <a href="#" class="right-banner__item">
                  <img
                    src="https://sanbongconhantao.com.vn/wp-content/uploads/2019/01/Phu-kien-san-bong.jpg"
                    loading="lazy"
                    class="right-banner__img"
                  />
                </a>
                <a href="#" class="right-banner__item">
                  <img
                    src="https://sanbongconhantao.com.vn/wp-content/uploads/2021/08/du-an-tieu-bieu-1024x323-1.png"
                    loading="lazy"
                    class="right-banner__img"
                  />
                </a>
        ...
        <div className="container-home container" style={{ marginTop: 40 }}>
          <img
            src="https://img.thegioithethao.vn/media/banner/banner-ban-muon-biet.png"
        ...
        <div className="image-one">
          ...
          <div className="texty-title">
            <p>
              Trải Nghiệm <strong style={{ color: "#F9B90F" }}>Ngay</strong>
            </p>
          </div>
          ...
          <div className="texty-demo">
            <Texty>Giải đấu</Texty>
          </div>

          <div className="texty-title">
            <p>
              Tham gia <strong style={{ color: "#F9B90F" }}>Ngay</strong>
            </p>
          </div>
          ...
          >
            {tours.slice(0, 20).map((item) => (
              <div
                className="col-product"
                onClick={() => handleReadMoreTour(item.id)}
                key={item.id}
                style={{ cursor: "pointer" }}
              >
                <div className="show-product">
                  ...
                  <div className="wrapper-products">
                    ...
                    <div className="truncate">Đội: {item.teams}</div>
                    <div className="truncate">Trận: {item.group_count}</div>

                    <div className="price-amount">
                      Tổng giải thưởng
                      <Paragraph className="price-product">
                        {numberWithCommas(Number(item.prizes))}đ
                      </Paragraph>
                    </div>
                  </div>
                </div>
        ...
        >
          ...
          >
            <Col justify="center" align="center" span={12}>
              <img src="https://datsan247.com/images/image_3.png" alt="" />
              <div className="text-md font-bold mt-4 w-[400px]">
                Dữ liệu sân đấu dồi dào, liên tục cập nhật, giúp bạn dễ dàng tìm
                kiếm theo khu vực mong muốn
              </div>
            </Col>
            <Col justify="center" align="center" span={12}>
              <img src="https://datsan247.com/images/image_4.png" alt="" />
              <div className="text-md font-bold mt-5 w-[400px]">
        ...
        <div className="card_wrap container-home container flex justify-center">
          <div>
            <Card
              bordered={false}
              className="card_suggest card_why card_slogan flex flex-col items-center"
            >
              <img
                src={service6}
                alt="Sân bóng tiện ích"
                className="mx-auto"
              ></img>
              <p className="card-text mt-3 fw-bold text-center">
                Tiện ích đầy đủ <br /> và hiện đại
              </p>
            </Card>
          </div>
          <div>
            ...
            >
              <img
                src={service7}
                alt="Chất lượng sân bóng"
                className="mx-auto"
              ></img>
              <p className="card-text mt-3 fw-bold text-center">
                Chất lượng sân bóng <br /> tốt nhất
              </p>
            </Card>
          </div>
          <div>
            ...
            >
              ...
              ></img>
              <p className="card-text mt-3 fw-bold text-center">
                Dịch vụ chuyên nghiệp <br /> và thân thiện
              </p>
            </Card>
          </div>
          <div>
            ...
            >
              ...
              ></img>
              <p className="card-text mt-3 fw-bold text-center">
                Đặt lịch linh hoạt <br /> và nhanh chóng
              </p>
            </Card>
          </div>
          <div>
            ...
            >
              ...
              <p className="card-text mt-3 fw-bold text-center">
                Hỗ trợ 24/7 <br /> đảm bảo trải nghiệm <br /> tốt nhất
              </p>
            </Card>
          </div>
        </div>
          ...
          <OverPack style={{ overflow: "hidden", height: 800, marginTop: 20 }}>
            ...
            >
              ...
              <div className="texty-title-footer">
                <p>
                  Tham Dự Buổi <strong>Ra Mắt Sân Bóng Mới</strong>
                </p>
              </div>
              <Row
                justify="center"
