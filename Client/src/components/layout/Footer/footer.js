...
function _Footer() {
  return (
    <Footer style={{ backgroundColor: "#17458B", padding: 30, paddingTop: 80 }}>
      <Row className="footer-desktop">
        ...
        <Col span={5} className="footer">
          ...
          >
            Trụ sở : 99, Nguyễn Chí Thanh, Láng Hạ, Đống Đa, Hà Nội
          </p>
        </Col>
        <Col span={4}>
          <strong
      ...
      <div style={{ textAlign: "center" }}>
        ...
        <p style={{ color: "#FFFFFF", fontSize: 13 }}>
          Copyright@ 2024 Created by To Quyet Tien
        </p>
        <p style={{ color: "#FFFFFF", fontSize: 13 }}>
